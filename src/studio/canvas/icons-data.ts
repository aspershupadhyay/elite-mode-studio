/**
 * icons-data.ts — Curated SVG icon library for the Design Studio
 *
...
interface IconCategory {
  id: string
  label: string
  icons: Omit<IconEntry, 'category' | 'categoryLabel'>[]
}
...
export const ALL_ICONS: IconEntry[] = ICON_CATEGORIES.flatMap((cat) =>

...
/** The subset of post content that the editor can modify. */
...
/** Minimal post shape required by this modal. */
...
interface EditFieldProps {
  ...
  local: EditableContent
  setLocal: React.Dispatch<React.SetStateAction<EditableContent>>
  multiline?: boolean
  mono?: boolean
}

function EditField({ label, field, local, setLocal, multiline = false, mono = false }: EditFieldProps): React.ReactElement {
...
function LiveHighlights({ words }: LiveHighlightsProps): React.ReactElement | null {
...
export default function PostEditorModal({ post, onSave, onClose }: PostEditorModalProps): React.ReactElement {
  const [local, setLocal] = useState<EditableContent>({ ...(post.content || {}) })

    ...
    <>
      ...
      {posts.length > 0 && (() => {
        ...
        const cardPosts = posts.map(post => {
          ...
          const imageQueued = !!post.post_id && !!imageGenQueue?.has(post.post_id) && !generatedImageUrl
          return { ...post, cardStatus, cardContent, generatedImageUrl, imageQueued }
        })
